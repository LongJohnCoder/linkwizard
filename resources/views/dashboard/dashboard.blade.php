                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    <tr>
                                        <td class="width-modification row-{{$url->id}}" onclick="window.location.href = '{{route('getLinkPreview',[$url->id])}}'" id="row-{{$url->id}}">@if($url->link_type==2) {{$url->title}}@else<a href="{{$shrt_url}}" id="link-{{$url->id}}" target="_blank">{{$shrt_url}}</a>@endif</td>
                                        @php
                                            $actual_url = '';
                                            $has_spl_url = 'n';
                                        ...
                                        <td class="width-modification row-{{$url->id}}" onclick="window.location.href = '{{route('getLinkPreview',[$url->id])}}'" id="row-{{$url->id}}">
                                            @if($url->link_type==2)<span class="badge badge-success">Group Link</span>
                                            @else
                                            <a href="{{$actual_url}}" data-index"{{$url->id}}">{{$actual_url}}</a>@endif
                                        ...
                                        <td class="row-{{$url->id}}" onclick="window.location.href = '{{route('getLinkPreview',[$url->id])}}'" id="row-{{$url->id}}">{{$url->created_at->format('M d, Y')}}</td>
                                        <td class="row-{{$url->id}}">
                                            @if($url->link_type!=2)
